...
from Codigos.linear_algebra import shape, get_row, get_column, make_matrix, \
    vector_mean, vector_sum, dot, magnitude, vector_subtract, scalar_multiply
from Codigos.stats import correlation, standard_deviation, mean
from Codigos.probability import inverse_normal_cdf
from Codigos.gradient_descent import maximize_batch
